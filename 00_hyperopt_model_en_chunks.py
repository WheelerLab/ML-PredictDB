...
#rf
open("/home/pokoro/data/paper_hyperopt/EN/"+pop+"_en_hyperopt_chr"+chrom+"_chunk"+
     chunk+".txt", "w").write("gene_id"+"\t"+"gene_name"+"\t"+"chr"+"\t"+
                              "best_hyperparam"+"\t")

for i in range(0, max_evals, 1):
     open("/home/pokoro/data/paper_hyperopt/EN/"+pop+"_en_hyperopt_chr"+chrom+
...
for gene in genes:
    ...
    if (type(cis_gt) != int) & (cis_gt.shape[1] > 0):
         ...
         open("/home/pokoro/data/paper_hyperopt/EN/"+pop+"_en_hyperopt_chr"+
